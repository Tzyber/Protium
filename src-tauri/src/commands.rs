...
fn env_overrides(vars: &[(String, String)], appdir: &str) -> Vec<(String, Option<String>)> {
...
/// waise weiter.
fn spawn_detached(program: &str, args: &[&str], url: &str) -> std::io::Result<()> {
...
mod tests {
    ...
    use super::{canonicalize_path, dir_size_inner, env_overrides, is_descendant_of, is_safe_path,
    path_identity, sanitize_path, validate_download_dest, validate_download_url,
    validate_external_url, validate_library_scope, validate_redirect_url, MAX_DOWNLOAD_BYTES};
