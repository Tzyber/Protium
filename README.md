...
fixes dieser liste wandern direkt auf main. 0.1.8 enthält den overhead-scan-refactor (dedup + dead code entfernt, details in PROTIUM_STATUS); 0.1.7 enthielt die snap-unterstützung sowie die inzwischen behobenen punkte dieser liste (sha512-warnung, cache-write-schutz, batchDirSizes, settings-andeutung entfernt); die offenen punkte kommen mit späteren versionen.
